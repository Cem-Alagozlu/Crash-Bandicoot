...
public:
	...
	void SetAnimation(std::wstring clipName, bool isLooping = true);
	void SetAnimation(UINT clipNumber, bool isLooping = true);
	void SetAnimation(AnimationClip clip, bool isLooping = true);
...
private:
	...
	bool m_IsPlaying{}, m_Reversed{}, m_ClipSet{}, m_IsLooping{};
